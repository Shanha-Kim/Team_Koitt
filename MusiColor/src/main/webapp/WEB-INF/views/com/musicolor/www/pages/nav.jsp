  ...
  <body class="bg-primary">
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-primary fixed-top">
      ...
      <ul class="nav navbar-nav ml-auto">
      	<c:if test="${empty SID}">
      	<li class="nav-item">
            <a class="nav-link" href="#"><i class="fas fa-sign-in-alt f-20"></i></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#"><i class="fas fa-user-plus f-20"></i></a>
        </li>
        </c:if>
        <c:if test="${not empty SID}">
      	...
      	<li class="nav-item">
          <a class="nav-link" href="#"><i class="fas fa-chart-line f-20"></i></a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#"><i class="fas fa-sign-in-alt fa-rotate-180 f-20"></i></a>
        </li>
        </c:if>
      </ul>
    </nav>

...
<div class="container" id="main">
	<!-- card -->
      <div class="card mb-3 bg-primary mb-5" id="sad">
        ...
        <!-- video -->
        <div class="youtube">
          <iframe width="1012" height="506" src="https://www.youtube.com/embed/aAkMkVFwAoo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <!-- body -->
    ...
    <li class="page-item">
	  ...
	  <div 	class="row">
        <div class="col-4 big-square">
          <div class="square small-angry"><img class="album" src="/www/img/christmas-4689129_640.jpg" /></div>
        </div>
        <div class="col-4 big-square">
          <div class="square small-sad"><img class="album" src="/www/img/christmas-4689129_640.jpg" /></div>
        </div>
        <div class="col-4 big-square">
          <div class="square small-happy"><img class="album" src="/www/img/christmas-4689129_640.jpg" /></div>
        </div>
